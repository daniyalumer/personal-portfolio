  ...
  return (
    <div className="min-h-screen bg-black text-white font-mono">
      ...
      <main className="container mx-auto px-4 py-12 space-y-24">
        {/* Hero Section */}
        <section className="flex flex-col md:flex-row items-center justify-between gap-8 min-h-[calc(100vh-200px)]">
          <div className="space-y-6 max-w-xl">
            <div className="inline-block px-3 py-1 border border-purple-400 text-purple-400 text-sm">
              Hello, my name is
            </div>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tighter">Daniyal Umer Haral</h1>
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 border-2 border-purple-400 p-2 bg-black">
        ...
        <section
          id="about"
          className="grid md:grid-cols-2 gap-12 items-center py-16 rounded-lg bg-gradient-to-br from-black to-purple-900/30"
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="border border-white/10 p-6 bg-white/5 space-y-2 hover:border-purple-400 transition-all duration-300">
        ...
        {/* Skills Section */}
        <section id="skills" className="space-y-12 py-16 rounded-lg bg-gradient-to-br from-purple-900/30 to-black">
          <h2 className="text-3xl font-bold tracking-tight border-b border-purple-400 pb-2 inline-block">
            ...
            <TabsContent value="languages" className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {["Python", "JavaScript", "TypeScript", "C++", "Java", "SQL", "Go", "Rust"].map((skill) => (
                  <div
                    key={skill}
                    className="border border-white/10 p-4 text-center hover:border-purple-400 transition-colors hover:transform hover:scale-105 duration-300"
                  >
        ...
        {/* Projects Section */}
        <section id="projects" className="space-y-12 py-16 rounded-lg bg-gradient-to-br from-black to-purple-900/30">
          <h2 className="text-3xl font-bold tracking-tight border-b border-purple-400 pb-2 inline-block">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <Card
                key={index}
                className="bg-transparent border border-white/10 overflow-hidden group hover:border-purple-400 transition-all duration-500"
              >
        ...
        {/* Experience Section */}
        <section id="experience" className="space-y-12 py-16 rounded-lg bg-gradient-to-br from-purple-900/30 to-black">
          <h2 className="text-3xl font-bold tracking-tight border-b border-purple-400 pb-2 inline-block">
        ...
        <section
          id="contact"
          className="space-y-8 max-w-2xl mx-auto text-center py-16 rounded-lg bg-gradient-to-br from-black to-purple-900/30"
        >
          <h2 className="text-3xl font-bold tracking-tight border-b border-purple-400 pb-2 inline-block">
          ...
          <div className="flex justify-center space-x-6">
            <Link
              ...
              className="p-3 border border-white/10 hover:border-purple-400 hover:text-purple-400 transition-colors hover:transform hover:scale-110 duration-300"
            >
          ...
          <Button className="bg-purple-400 text-black hover:bg-purple-500 mt-4">Send Message</Button>
        </section>
      </main>
